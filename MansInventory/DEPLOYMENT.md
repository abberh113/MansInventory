...
gcloud run services update manspos \
  --set-env-vars DATABASE_URL="postgresql+asyncpg://user:password@aws-1-eu-west-2.pooler.supabase.com:6543/postgres",SECRET_KEY = "YOUR_SECRET_KEY_HERE",ALGORITHM="HS256" \
  --region europe-west1
```
